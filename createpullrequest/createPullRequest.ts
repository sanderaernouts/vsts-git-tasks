...
async function run() {
    ...
    if(selectionMethod === "currentBuild") {
        ...
        tl.warning("this task is deprecated and is no longer being maintained. The 'az repo pr create' Azure CLI command combined with the Azure CLI task offers similar. See: https://learn.microsoft.com/en-us/cli/azure/repos/pr?view=azure-cli-latest#az-repos-pr-create.");
